...
function App() {
  return (
    <div className="flex flex-col  items-center h-[160vh] w-screen bg-black">
      <div className="w-[95%] h-[10vh] flex flex-row  items-center ">
        <h1 className="font-bold text-red-600 text-5xl ">Group Name we decide on here</h1>
        <button
  className="ml-auto btn btn-primary bg-red-600 text-white ml-4 rounded-lg p-2"
  onClick={() => window.open("https://docs.google.com/document/d/166-ueD3p6o1Z-NS121zrDiKiRNg0ev4cvF4SFrxoIFg", "_blank")}
>
  Open Google Doc
</button>
      </div>
